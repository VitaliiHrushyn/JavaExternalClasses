...
//import ua.testing.cars_and_drivers.model.entity.Shop;
//@Deprecated
...
//	}
//	
////	private Driver extractUniqueManufacturer(ResultSet rs) throws SQLException {
////		Driver manufacturer = DAOFactory.getInstance().createManufacturerDAO().getById(rs.getInt(IDMANUFACTURER));
